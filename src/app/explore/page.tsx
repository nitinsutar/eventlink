        ...
        <form className="mt-6 flex flex-col gap-3 sm:flex-row">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="h-11 w-full rounded-xl border border-border bg-card pl-10 pr-4 text-sm"
            />
          </div>
          <select
            name="city"
          ...
          <button
            type="submit"
            className="h-11 rounded-xl bg-accent px-6 text-sm font-semibold text-accent-foreground"
          >
            Search
          </button>
        </form>
          ...
          {!vendors || vendors.length === 0 ? (
            <div className="rounded-2xl border border-dashed border-border py-20 text-center">
              <p className="text-muted-foreground">
                No vendors found. Try different filters or be the first to create
                a profile.
              </p>
              <Link
              ...
              {vendors.map((vendor) => {
                ...
                return (
                  <Link
                    ...
                    className="group overflow-hidden rounded-2xl border border-border bg-card transition hover:border-accent/50 hover:shadow-md"
                  >
